...
func main() {
	...
	messages := []struct {
		...
		{"saludo.holamundo", "1) Hola"},
		{"saludo.lucas", "2) Hola lucas!"},
		{"saludo.kimy", "3) Hola kimy!"},
		{"saludo.carlos", "4) Hola carlos!"},
		{"saludo.andres", "5) Hola andres!"},
		{"saludo.lele", "6) Hola lele!"},
		{"saludo.fran", "7) Hola fran!"},
	}
	...
	for i, msg := range messages {
		...
		time.Sleep(100 * time.Millisecond) // Pausa entre mensajes
	}
